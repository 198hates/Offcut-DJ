...
const api = {
  ...
  engine: {
    ...
    setFilter:    (deckId: string, knob: number) => ipcRenderer.send('engine:setFilter', deckId, knob),
    setDelay:     (deckId: string, timeMs: number, feedback: number, mix: number, enabled: boolean) => ipcRenderer.send('engine:setDelay', deckId, timeMs, feedback, mix, enabled),
