...
import type { UsbExport, UsbPlaylistNode, UsbTrack, UsbDeviceSettings, UsbWaveformColors, UsbPreflight } from '@shared/types'
...
export function RekordboxUsbPanel(): JSX.Element {
  ...
  const syncSelected = useCallback(async () => {
    ...
    await read(usbRoot)
  }, [usbRoot, selectedPlaylists, libTrackById, showToast, read, syncMode, preflight, aggregate.bytes])
